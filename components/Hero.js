  ...
  return (
    <section>
      ...
      <div className="flex justify-center items-center">
        <div className="absolute flex flex-col space-y-3 top-1/4 w-full justify-content items-center max-w-screen-sm mx-auto p-8 -mt-16">
          ...
          <p className="text-xs text-center ">
            Get Premier Access to House Of The Dragon for an additional fee
            with a Disney+ subscription. As of 12/24/22, the price of Disney+
            and The Disney Bundle will increase by 69₹
          </p>
